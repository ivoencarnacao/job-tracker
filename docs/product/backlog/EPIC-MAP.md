...
| ---- | -------------------------------------------------------------------------------- | -------- | ------ | -------------- |
| ID01 | [User Registration & Authentication](01-identity/EPIC-ID01-user-registration.md) | P0       | 2      | VS-01          |
...
| ID   | Epic                                                                   | Priority | Slices | Vertical Slice |
| ---- | ---------------------------------------------------------------------- | -------- | ------ | -------------- |
| SK01 | [Skill Catalog & Manual Tagging](04-skills/EPIC-SK01-skill-catalog.md) | P1       | 2      | VS-09          |
| SK02 | [Automatic Skill Extraction](04-skills/EPIC-SK02-skill-extraction.md)  | P1       | 2      | VS-10          |
| SK03 | [Skill Insights](04-skills/EPIC-SK03-skill-insights.md)                | P1       | 1      | VS-11          |

## Dashboard Context (Supporting)

| ID   | Epic                                                                    | Priority | Slices | Vertical Slice |
| ---- | ----------------------------------------------------------------------- | -------- | ------ | -------------- |
| DA01 | [Core Dashboard Metrics](03-dashboard/EPIC-DA01-core-metrics.md)        | P0       | 3      | VS-07          |
| DA02 | [Skill Insights Display](03-dashboard/EPIC-DA02-skill-insights-view.md) | P1       | 1      | VS-11          |
